...
public class JwtSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                // .oauth2ResourceServer(OAuth2ResourceServerConfigurer::jwt) // Deprecated in
                // SB 3.1.x
                ...
                // })
                .headers(header -> header.frameOptions(HeadersConfigurer.FrameOptionsConfig::sameOrigin)) // Starting
                // from SB
                // 3.1.x using
                // Lambda DSL
                .build();
    ...
    public UserDetailsService userDetailsService() {
        UserDetails user = User.withUsername("irfan")
